...
Die verbreitetsten Webserver-Produkte sind Apache \acs{HTTP} Server, Microsoft Internet Information Server (\acs{ISS}) und nginx \cite{Rouse2012}. %TODO Servlet Webserver - Tomcat, Jetty
...
Unter dieser Kategorisierung gibt es sehr verschiedene Modelle. Folgend sind die wichtigsten Datenmodelle mit je einem Beispiel:
