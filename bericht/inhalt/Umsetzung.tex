...
Die Anwendung ist so aufgebaut, dass es für den Inhalt jeder Seite eine Komponente gibt. Diese kann wiederum aus weitere Komponenten bestehen, die in das Template eingebunden werden. Ein Beispiel davon ist die Produktauflistung zu jedem Kategorie-Reiter. Alle Seiten dieser Art sehen wie auf \cref{fig:items_list} aus. Die rote Markierungen identifizieren die zwei Kind-Komponenten die eingebunden sind.
