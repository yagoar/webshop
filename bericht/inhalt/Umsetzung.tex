...
Neben diesen semi-automatischen Funktionen können aber auch eigene Methoden definiert werden. Dafür kann über eine Annotation (\textt{@Query}) eine \acs{SQL}-Query für die Abfrage an die Datenbank definiert werden.
