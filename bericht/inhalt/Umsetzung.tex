...
Abbildung \ref{fig:inheritanceMapping} zeigt die Klassen-Definitionen mit den Annotationen für das \acs{ORM}.

\begin{figure}[th!]
	\centering
	\includegraphics[width=0.8\linewidth]{bilder/kap7/Vererbungshierarchie}
	\caption{Vererbungshierarchie}
	\label{fig:inheritanceMapping}
\end{figure}
