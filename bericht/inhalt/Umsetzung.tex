...
%TODO Grundlegende Services, Observer Pattern im Shopping Cart Service
...
In den Zeilen 3 und 4 von \cref{lst:service} werden Header für die HTTP-Anfrage vorbereitet. 

\subsubsection{Styling}
%TODO Boostrap, wie funktioniert es (Grid-Paradigma), wie eingebunden

%TODO Styling Entscheidungen, collapsible Menü mit ng2-bootstrap
